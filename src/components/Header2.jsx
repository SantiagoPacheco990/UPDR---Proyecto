    ...
    <div>
      <header className="header2">
        ...
        <div className="container-el-OAAA">
          <h1 className="OOAAA"><span className='OO'>OO</span><span className='AAA'>AAA</span><span className='OO'>!!</span></h1>
        ...
        <div className="container-opciones">
          <div className="container-ayuda">
            <img src={logoAyuda} className='ayuda'/>
            <p>Ayuda</p>
          </div>
          <div className="container-usuario">
            <img src={logoUsuario} className='usuario'/>
            <p>Mi cuenta</p>
          </div>
